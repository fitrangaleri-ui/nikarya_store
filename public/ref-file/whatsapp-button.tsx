        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="leading-tight">
                  <div className="flex items-center gap-1.5">
                    <p className="text-base font-semibold">Custom Galeri Store</p>
                    <Image
                      src="/icon/verify.png"
                      alt="Verified"
                      width={14}
            ...
            <div className="px-4 py-5 space-y-5 bg-gradient-to-b from-muted/20 to-transparent">
              <div className="rounded-2xl bg-white/90 dark:bg-zinc-900/80 p-4 text-[#303030] shadow-sm border border-border/40 relative">
                <div className="absolute -left-1.5 top-4 w-3 h-3 bg-white/90 dark:bg-zinc-900/80 border-l border-t border-border/40 rotate-[-45deg]" />
                <div className="flex items-center justify-between">
                  <p className="text-xs font-medium text-accent uppercase tracking-tight">
                    Customer Support
                  </p>
                ...
                <p className="mt-1.5 text-sm leading-relaxed text-foreground/70 font-normal whitespace-pre-wrap">
              ...
              <div className="space-y-1.5">
                <div className="flex items-end gap-2 rounded-2xl bg-white/90 dark:bg-zinc-900/80 border border-border/40 px-3 py-2 shadow-sm">
                  <textarea
                    ref={textareaRef}
                    value={message}
                    onChange={(e) => {
