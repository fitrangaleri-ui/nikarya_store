...
export const metadata = {
  title: "404 - Halaman Tidak Ditemukan | Nikarya Store",
  description: "Maaf, halaman yang Anda cari tidak dapat ditemukan di Nikarya Store.",
};

export default function NotFound() {
  return (
    <main className="relative flex min-h-[80vh] w-full items-center justify-center bg-background px-4 py-8 sm:py-12 md:py-16 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md sm:max-w-lg">
        ...
        <div className="flex flex-col items-center rounded-3xl border border-border/60 bg-card/60 p-6 text-center shadow-xl backdrop-blur-xl sm:p-8 md:p-10">
          ...
          >
            Maaf, halaman yang Anda cari tidak tersedia, telah dipindahkan, atau tautan yang dimasukkan salah.
          </Typography>

          {/* Action Buttons (Mobile First: Full-width stacked on mobile, inline row on sm) */}
