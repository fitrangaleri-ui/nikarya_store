...
export function StickyHeader({
  ...
  return (
    <div className="sticky md:top-0 z-30 overflow-hidden border-b border-white/10 bg-gradient-to-br from-primary to-secondary-foreground px-6 py-6 md:px-10 md:py-8 transition-all">
