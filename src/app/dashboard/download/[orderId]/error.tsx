...
export default function ErrorDownload({
  ...
  return (
    <div className="max-w-2xl mx-auto flex flex-col items-center justify-center py-24 animate-in fade-in duration-500">
      <div className="w-full max-w-md text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Typography variant="body-sm" color="muted" align="center" className="max-w-sm mx-auto">
            Maaf, terjadi kesalahan saat memuat halaman download. Silakan coba lagi.
          </Typography>
        </div>
