          ...
          <div className="px-6 py-6 space-y-5">
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Mari mulai berbelanja dan tambahkan produk favoritmu ke
                keranjang!
              </p>
            </div>
            <Button
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_400px]">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-border/40 bg-card/40 backdrop-blur-md shadow-sm overflow-hidden">
            {/* Section Header */}
            <div className="relative bg-primary/5 border-b border-border/40 px-6 py-4 flex items-center gap-3">
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-border/40 bg-card/40 backdrop-blur-md shadow-sm overflow-hidden lg:sticky lg:top-24">
            ...
            <div className="p-6 md:p-8">
              ...
              <ul className="space-y-4 mb-6">
                {cartItems.map((item) => (
                  <li key={item.id} className="flex gap-4">
                    <div className="relative w-16 h-16 flex-shrink-0 rounded-2xl overflow-hidden bg-muted/30 border border-border/40">
                      {item.thumbnail_url ? (
                        <Image
              ...
              {/* Promo Code */}
              <div className="pt-5 border-t border-border/40 mb-4">
                ...
                {appliedPromo ? (
                  <div className="flex items-center justify-between bg-primary/5 border border-primary/20 rounded-2xl px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-semibold text-primary/70">
                        −Rp{" "}
                        {appliedPromo.discountAmount.toLocaleString("id-ID")}
                      </span>
                    </div>
                    <button
                  ...
                  <div className="flex gap-2">
                    <div className="flex-1 rounded-2xl bg-muted/30 border border-border/40 overflow-hidden">
                      <Input
                        value={promoInput}
                        onChange={(e) => {
                        ...
                        className="h-10 px-4 border-0 bg-transparent shadow-none focus-visible:ring-0 text-sm uppercase font-medium"
                        onKeyDown={(e) =>
              ...
              {/* Totals */}
              <div className="pt-4 border-t border-border/40 mb-6 space-y-2">
                ...
                <div className="flex items-end justify-between pt-3 border-t border-dashed border-border/40">
              ...
              {/* Error */}
              {error && (
                <div className="mb-5 rounded-2xl bg-red-500/5 border border-red-500/20 px-4 py-3 flex items-start gap-2 animate-in fade-in zoom-in-95">
              ...
              <div className="space-y-3">
                <Button
                  ...
                  variant="brand"
                  size="lg"
                  className="w-full h-14 hover:shadow-[0_6px_20px_rgba(13,148,136,0.23)] hover:-translate-y-0.5 transition-all"
                >
                  {loading ? (
                    <>
