...
function Slider({
  ...
  return (
    <SliderPrimitive.Root
      data-slot="slider"
      className={cn(
        "relative flex w-full touch-none items-center select-none data-[orientation=vertical]:h-full data-[orientation=vertical]:min-h-44 data-[orientation=vertical]:w-6 data-[orientation=vertical]:flex-col",
        className
      )}
      {...props}
    >
